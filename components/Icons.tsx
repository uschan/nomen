...
export const Icons = {
  ...
  // Inner Circle / Sanctuary (Torii Gate Style)
  Torii: ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M4 4h16"/>
      <path d="M4 8h16"/>
      <path d="M7 4v16"/>
      <path d="M17 4v16"/>
      <path d="M2 4c0 0 2-2 10-2s10 2 10 2"/>
    </svg>
  ),
  ...
  ScrollText: ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M8 21h12a2 2 0 0 0 2-2v-2a10 10 0 0 0-10-10H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h4Zm0 0 4-4m-4 4-4-4"/></svg>
  ),
  Candle: ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M11 2h2"/><path d="M12 2v4"/><path d="m8 6 8 1.5"/><path d="M6 10v9a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3v-9"/><path d="M12 14v.01"/></svg>
  ),
